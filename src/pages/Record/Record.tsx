        ...
        <IonPage>
            ...
            <IonContent>
                <div className="page-content">
                    ...
                    <SelectComponent list={categoryList} label="Category" handleChange={(value) => handleChangeForm('category', value)} />
                    <DatePicker label="Spent on" />
                    <SelectComponent list={SOURCES} label="Source" handleChange={(value) => handleChangeForm('source', value)} />
